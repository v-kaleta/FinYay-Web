      ...
      <section id="patterns" className="px-5 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-border bg-card p-7 shadow-soft">
              <p className="font-mono text-xs font-bold uppercase tracking-widest text-primary">
                fill_the_structure · Minh's Budget
              </p>
              <p className="mt-3 text-sm text-ink-soft">
                Minh earns $45 a week helping at his dad's restaurant. Word problems give the clues
                — kids work out each field themselves.
              </p>
              <table className="mt-4 w-full border-collapse text-sm">
                <tbody>
                  <tr>
                    <td className="border-b border-border py-1.5 pr-3 text-ink-soft">Earnings</td>
                    <td className="border-b border-border py-1.5 font-mono">$45</td>
                    <td className="border-b border-border py-1.5 pr-3 pl-6 text-ink-soft">Guitar lesson</td>
                    <td className="border-b border-border py-1.5 font-mono">?</td>
                  </tr>
                  <tr>
                    <td className="border-b border-border py-1.5 pr-3 text-ink-soft">Bank</td>
                    <td className="border-b border-border py-1.5 font-mono">?</td>
                    <td className="border-b border-border py-1.5 pr-3 pl-6 text-ink-soft">Left over</td>
                    <td className="border-b border-border py-1.5 font-mono">?</td>
                  </tr>
                  <tr>
                    <td className="py-1.5 pr-3 text-ink-soft">Art class</td>
              ...
              <p className="mt-4 text-sm text-ink">
                "Minh puts 1/3 of what he earns in the bank. How much goes into the bank?"
              </p>
              <p className="mt-4 text-sm text-ink-soft">
                Same "layout + fields + answer key" shape every time — one fraction step per early
                question, a harder multi-step question at the end.
              </p>
            </div>
          </div>
        </div>
